...
class SAT(BaseEnv):
    ...
    k: int
    m: int
    def __init__(self, n=15, k=10, m=None):
    ...
    async def generate(self):
        ...
        return af.Challenge(env=self.name, prompt=prompt, extra={"sol": sol, "cls": cls})        
    ...
    async def evaluate(self, challenge: af.Challenge, response: af.Response):
        ...
        return af.Evaluation(env=self.name, score=float(ok), extra={"expected": sol, "got": got})
